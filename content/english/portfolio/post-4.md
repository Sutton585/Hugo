...
<!-- {{< video src="images/case-studies/msm/video.gif" width="100%" height="auto" autoplay="true" loop="true" muted="true" controls="true" class="rounded-lg" >}} -->
{{< image src="images/case-studies/msm/video.gif" alt="alter-text" zoomable="true" width="100%" position="center" command="fill">}}
